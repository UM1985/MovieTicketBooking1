...
if(selectedTime){
  ...
  return show ? (
    <div className="flex flex-col md:flex-row  px-6 md:px-16 lg-px-40 py-30 ,d:pt-50">
      {/* Available Timing */}
        ...
        <div className="mt-5 space-y-1">
          {show.dateTime[date].map((item) => (
            <div
              ...
              className={`flex items-center gap-2 px-6 py-2 w-max rounede-r-md cursor-pointer transition ${
